...
public class DevicePath{
	...
	private ArrayList<String> sataList;
	...
	public ArrayList<String> getSataStoragePath(){
		return (ArrayList<String>) sataList.clone();
	}
