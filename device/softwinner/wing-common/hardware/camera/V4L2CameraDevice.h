...
//the macro used for enable the scale preview frame, when the size is 1920x1080,scale it to 960x540
#define SCALE_PREVIEW_ENABLE 0
#define SCALE 2

//the macro used for enable the dynamic frame rate,when the  size is 1920x1080 and the framerate is 30fps,the preview rate will down to 15~30fps
//the encord rate is unchanged
#define DYNAMIC_RATE_PREVIEW_ENABLE 1
