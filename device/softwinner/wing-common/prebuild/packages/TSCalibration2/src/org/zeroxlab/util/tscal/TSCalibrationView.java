...
public class TSCalibrationView extends View {
    ...
    public TSCalibrationView(TSCalibration context, int h, int w ,boolean fileexist) {
        ...
        P_Y_RIGHT_CORNER_MAX_LIMIT 		= SCREEN_MAX_HEIGHT - Y_COMPENSATE - 50 + P_DELTA;
        P_Y_RIGHT_CORNER_MIN_LIMIT 		= SCREEN_MAX_HEIGHT - Y_COMPENSATE - 50 - P_DELTA;
        ...
        P_Y_CENTER_MAX_LIMIT 			= SCREEN_MAX_HEIGHT/2 + P_DELTA;
        P_Y_CENTER_MIN_LIMIT 			= SCREEN_MAX_HEIGHT/2 - P_DELTA;
        mContext = context;
