...
public final class BatteryService extends Binder {
    ...
    private static final String POWER_CHARGE_STATE_PATH = "/sys/class/power_supply/battery/chgen";
	...
	public void setChargeState(boolean state){
        FileWriter wr=null;
        try {
            wr = new FileWriter(POWER_CHARGE_STATE_PATH);
            if (state)
            ...
            wr.close();
             ...
             Log.i(TAG," setChargeState error: " + e.getMessage());
        }
	}
