...
LOCAL_MODULE := icu_48.dat
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT)/usr/icu_48
LOCAL_MODULE_STEM := $(root)_48.dat
LOCAL_SRC_FILES := $(root)-$(config).dat
include $(BUILD_PREBUILT)

ifeq ($(WITH_HOST_DALVIK),true)
    $(eval $(call copy-one-file,$(LOCAL_PATH)/$(root)-$(config).dat,$(HOST_OUT)/usr/icu_48/$(root)_48.dat))
endif
